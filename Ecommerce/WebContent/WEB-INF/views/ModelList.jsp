...
<table width="75%" border="1">
  <tr>
    <td><form name="modelDetail1" method="POST" action="com.ecommerce.servlet/CartControllerServlet">
 <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model:</strong>
    ...
    <td><form name="modelDetail2" method="POST" action="com.ecommerce.servlet/CartControllerServlet"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model</strong>:
...
<font face="Verdana, Arial, Helvetica, sans-serif">
  ...
  <tr>
    <td><form name="modelDetail3" method="POST" action="com.ecommerce.servlet/CartControllerServlet"><p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model:</strong>
    ...
    <td><form name="modelDetail4" method="POST" action="com.ecommerce.servlet/CartControllerServlet"><p><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Model</strong>:
